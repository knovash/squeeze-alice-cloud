...
import org.knovash.alicebroker.utils.HandlerUtilsNew;
...
//      HEADERS
        ...
        String xRequestId = headers.getFirst("X-org.knovash.alicebroker.Request-Id");
...
//      QUERY
        ...
        HashMap<String, String> queryMap = HandlerUtilsNew.convertQueryToMap(query);
